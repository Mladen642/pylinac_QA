...
class MyWindow(QtWidgets.QMainWindow):
    ...
    def menu_about(self):
        QMessageBox.information(self, "About this app", "This app was developed to assist medical physics team in QA duties for linac and CT in our clinic.\n\nDesigned and coded by MSc Mladen Babić")
    ...
    def fa_calc(self):
        ...
        if self.ui.fa_elekta.isChecked() == True:
            ...
            try:
                ...
                if x != True:
                    QMessageBox.warning(self, "Error!", "No files selected! Please try again.")
                    fa_files_analysis = None
            except:
                QMessageBox.warning(self, 'Error!', "You have not selected file(s) so the calculation cannot proceed.")     
            ...
            try:
                ...
                QMessageBox.information(self, "Done! Here are the results.", fa_result.results())
                fa_result.plot_analyzed_image()
                
                fa_result.publish_pdf(f'./files/pdf_reports/[QA]FieldAnalysis_{str_today_date}.pdf')
            except:
                QMessageBox.warning(self, "Error!", "Calculation failed. Please read the instructions carefully and try again.")

        elif self.ui.fa_varian.isChecked() == True:
            QMessageBox.information(self, "Varian", "Varian analysis not yet supported. Comming soon")
        else:
            QMessageBox.warning(self, "Warning", "You need to select which Protocol to follow before you can continue.")
    ...
    def pi_calc(self):
        ...
        if self.ui.pi_LasVegas.isChecked() == True:
            ...
            try:
                ...
                QMessageBox.information(self, "Done! Here are the results.", pi_result.results())
            ...
            QMessageBox.information(self, "LeedsTOR", "LeedsTOR analysis not yet supported. Comming soon")
        else:
            QMessageBox.warning(self, "Warning", "You need to select which phantom to use before you can continue.")
    ...
    def cat_calc(self):
        ...
        if self.ui.cat_503.isChecked() == True:
            ...
            try:
                ...
                QMessageBox.information(self, "Done! Here are the results.", cat_result.results())
            ...
            QMessageBox.information(self, "CatPhan504", "CatPhan504 analysis not yet supported. Comming soon")
        else:
            QMessageBox.warning(self, "Warning", "You need to select which phantom to use before you can continue.")
